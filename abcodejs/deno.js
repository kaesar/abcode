...
function start(script, plan) {
    ...
    return transpileLines('Deno', script, transpileLine);
}
...
const checkUse = (indent, code) => {
    ...
    if (lib === '@abc')
        ...
        lib = 'fastro from "https://deno.land/x/fastro/server/mod.ts";';
        //lib = '{ Application, Context } from "https://deno.land/x/abc/mod.ts";';
        //lib = 'Aqua from "https://deno.land/x/aqua/mod.ts";';
    else if (lib === "@mongodb")
